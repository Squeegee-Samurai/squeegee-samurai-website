        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">
              ...
              <span className="text-accent-400">in Ashburn, VA</span>
            </h1>
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              <div className="p-6">
                ...
                <ul className="text-sm text-neutral-600 space-y-2 mb-6">
                  ...
                  <li className="flex items-center"><CheckCircle className="w-4 h-4 text-accent-500 mr-2" />Upto 3rd-story capabilities</li>
