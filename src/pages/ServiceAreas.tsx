  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Proudly Serving Loudoun County</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {cities.map((city) => (
              <div key={city.name} className="bg-white rounded-lg shadow-lg border border-gray-200 p-6">
                ...
                <div className="mb-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {city.zipCodes.map((zip) => (
                      <span key={zip} className="bg-blue-100 text-blue-800 px-2 py-1 rounded text-sm">
                        {zip}
                      </span>
                    ))}
                  </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">What We Offer in Every Service Area</h2>
            <p className="text-lg text-gray-600">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-blue-50 rounded-lg p-8">
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">Service Area Information</h2>
              <p className="text-lg text-gray-600">
